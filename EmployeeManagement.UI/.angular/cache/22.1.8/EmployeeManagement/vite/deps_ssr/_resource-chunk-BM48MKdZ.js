...
//#endregion
export { NG_PIPE_DEF as $, viewAttachedToChangeDetector as $i, getLView as $n, leaveDI as $r, assertParentView as $t, EMPTY_OBJ as A, setCurrentTNode as Ai, formatRuntimeError as An, isDirectiveHost as Ar, assertFirstUpdatePass as At, INJECTOR$1 as B, signalAsReadonlyFn as Bi, getContextLView as Bn, isLView as Br, assertLContainer as Bt, ChangeDetectionScheduler as C, consumerPollProducersForChange as Ca, runInInjectorProfilerContext as Ci, emitInstanceCreatedByInjectorEvent as Cn, isClassProvider as Cr, arraySplice as Ct, DOC_PAGE_BASE_URL as D, setActiveConsumer as Da, setBindingRootForHostBindings as Di, errorHandlerEnvironmentInitializer as Dn, isCreationMode as Dr, assertElement as Dt, DOCUMENT as E, producerAccessed as Ea, setBindingIndex as Ei, enterView as En, isContentQueryHost as Er, assertDomNode as Et, EnvironmentInjector as F, setInjectorProfilerContext as Fi, getBindingsEnabled as Fn, isInI18nBlock as Fr, assertInInjectionContext as Ft, Injector as G, stringifyForError as Gi, getCurrentTNode as Gn, isSkipHydrationRootTNode as Gr, assertNotDefined as Gt, INJECTOR_SCOPE as H, storeCleanupWithContext as Hi, getCurrentDirectiveIndex as Hn, isRefreshingViews as Hr, assertLessThan as Ht, ErrorHandler as I, setIsInCheckNoChangesMode as Ii, getClosureSafeProperty as In, isInInjectionContext as Ir, assertIndexInDeclRange as It, NG_DIR_DEF as J, truncateMiddle as Ji, getDirectiveDefOrThrow as Jn, isWritableSignal as Jr, assertNotReactive as Jt, MATH_ML_NAMESPACE as K, throwError as Ki, getCurrentTNodePlaceholderOk as Kn, isStandalone as Kr, assertNotEqual as Kt, EventEmitter as L, setIsRefreshingViews as Li, getComponentDef as Ln, isInSkipHydrationBlock as Lr, assertIndexInExpandoRange as Lt, ERROR_DETAILS_PAGE_BASE_URL as M, setInI18nBlock as Mi, getAllSpecialProviders as Mn, isExhaustiveCheckNoChanges as Mr, assertGreaterThan as Mt, EffectRefImpl as N, setInjectImplementation as Ni, getBindingIndex as Nn, isForwardRef as Nr, assertGreaterThanOrEqual as Nt, DestroyRef as O, setThrowInvalidWriteToSignalError as Oa, setCurrentDirectiveIndex as Oi, fillProperties as On, isCurrentTNodeParent as Or, assertEqual as Ot, EffectScheduler as P, setInjectorProfiler as Pi, getBindingRoot as Pn, isInCheckNoChangesMode as Pr, assertHasParent as Pt, NG_MOD_DEF as Q, validAppIdInitializer as Qi, getInjectorDef as Qn, lastNodeWasCreated as Qr, assertOneOf as Qt, IMAGE_CONFIG as R, setSelectedIndex as Ri, getComponentLViewByIndex as Rn, isInjectable as Rr, assertIndexInRange as Rt, CSP_NONCE as S, consumerDestroy as Sa, runInInjectionContext as Si, emitInjectorToCreateInstanceEvent as Sn, internalImportProvidersFrom as Sr, arrayInsert2 as St, DEBUG_TASK_TRACKER as T, getActiveConsumer as Ta, scheduleCallbackWithRafRace as Ti, enterDI as Tn, isComponentHost as Tr, assertDirectiveDef as Tt, INTERNAL_APPLICATION_ERROR_HANDLER as U, storeLViewOnDestroy as Ui, getCurrentParentTNode as Un, isRootView as Ur, assertNgModuleType as Ut, INJECTOR_DEF_TYPES as V, store as Vi, getCurrentDirectiveDef as Vn, isProjectionTNode as Vr, assertLView as Vt, InjectionToken as W, stringify as Wi, getCurrentQueryIndex as Wn, isSignal as Wr, assertNodeInjector as Wt, NG_FACTORY_DEF as X, unwrapRNode as Xi, getFactoryDef as Xn, keyValueArrayIndexOf as Xr, assertNumber as Xt, NG_ELEMENT_ID as Y, unwrapLView as Yi, getElementDepthCount as Yn, keyValueArrayGet as Yr, assertNotSame as Yt, NG_INJ_DEF as Z, updateAncestorTraversalFlagsOnAttach as Zi, getInjectableDef as Zn, keyValueArraySet as Zr, assertNumberInRange as Zt, untracked as _, REACTIVE_NODE as _a, renderStringify as _i, debugStringifyTypeForError as _n, increaseElementDepthCount as _r, ZONELESS_ENABLED as _t, ResourceParamsStatus as a, ɵɵdefineInjectable as aa, markAncestorsForTraversal as ai, assertTNodeCreationIndex as an, getNgModuleDef as ar, PLATFORM_INITIALIZER as at, APP_ID as b, consumerAfterComputation as ba, resolveForwardRef as bi, effect as bn, inject as br, angularZoneInstanceIdProperty as bt, computed as c, ɵɵenableBindings as ca, nextBindingIndex as ci, attachInjectFlag as cn, getOrCreateLViewCleanup as cr, PendingTasksInternal as ct, invalidResourceCreationInParams as d, ɵɵnamespaceHTML as da, provideBrowserGlobalErrorListeners as di, convertToBitFlags as dn, getSelectedIndex as dr, SCHEDULE_IN_ROOT_ZONE as dt, viewAttachedToContainer as ea, leaveSkipHydrationBlock as ei, assertProjectionSlots as en, getLViewParent as er, NG_PROV_DEF as et, isInParamsFunction as f, ɵɵnamespaceMathML as fa, provideEnvironmentInitializer as fi, createInjector as fn, getSelectedTNode as fr, SecurityContext as ft, setInParamsFunction as g, setCurrentInjector as ga, removeLViewOnDestroy as gi, cyclicDependencyErrorWithDetails as gn, importProvidersFrom as gr, XSS_SECURITY_URL as gt, rethrowFatalErrors as h, ɵɵrestoreView as ha, removeFromArray as hi, cyclicDependencyError as hn, hasI18n as hr, Version as ht, ResourceImpl as i, ɵunwrapWritableSignal as ia, makeStateKey as ii, assertTNode as in, getNativeByTNodeOrNull as ir, PLATFORM_ID as it, ENVIRONMENT_INITIALIZER as j, setCurrentTNodeAsNotParent as ji, forwardRef as jn, isEnvironmentProviders as jr, assertFunction as jt, EMPTY_ARRAY as k, signalSetFn as ka, setCurrentQueryIndex as ki, flatten as kn, isDestroyed as kr, assertFirstCreatePass as kt, encapsulateResourceError as l, ɵɵinject as la, nextContextImpl as li, checkSecurityContext as ln, getOrCreateTViewCleanup as lr, R3Injector as lt, resource as m, ɵɵresetView as ma, registerSpecialProvider as mi, createViewEffect as mn, getTView as mr, VERSION as mt, OutputEmitterRef as n, walkUpViews as na, load as ni, assertString as nn, getNativeByIndex as nr, NoopNgZone as nt, ResourceValueError as o, ɵɵdefineInjector as oa, markViewForRefresh as oi, assertTNodeForLView as on, getNgModuleDefOrThrow as or, PROVIDED_ZONELESS as ot, linkedSignal as p, ɵɵnamespaceSVG as pa, providerToFactory as pi, createInjectorWithoutInjectorInstances as pn, getTNode as pr, TransferState as pt, NG_COMP_DEF as q, throwProviderNotFoundError as qi, getDirectiveDef as qn, isTypeProvider as qr, assertNotInReactiveContext as qt, ResourceDependencyError as r, wasLastNodeCreated as ra, makeEnvironmentProviders as ri, assertTIcu as rn, getNativeByTNode as rr, NullInjector as rt, chain as s, ɵɵdisableBindings as sa, newArray as si, assertTNodeForTView as sn, getNullInjector as sr, PendingTasks as st, CACHE_ACTIVE as t, walkProviderTree as ta, leaveView as ti, assertSame as tn, getNamespace as tr, NgZone as tt, getOutputDestroyRef as u, ɵɵinvalidFactoryDep as ua, promiseWithResolvers as ui, concatStringsWithSpace as un, getPipeDef as ur, RuntimeError as ut, require_operators as v, SIGNAL as va, requiresRefreshOrTraversal as vi, decreaseElementDepthCount as vn, incrementBindingIndex as vr, _global as vt, CheckNoChangesMode as w, createComputed as wa, scheduleCallbackWithMicrotask as wi, emitProviderConfiguredEvent as wn, isComponentDef as wr, assertDefined as wt, CONTAINER_HEADER_OFFSET as x, consumerBeforeComputation as xa, retrieveTransferredState as xi, emitInjectEvent as xn, injectRootLimpMode as xr, arrayEquals as xt, ANIMATION_MODULE_TYPE as y, SIGNAL_NODE as ya, resetPreOrderHookFlags as yi, deepForEach as yn, initNgDevMode as yr, addToArray as yt, IMAGE_CONFIG_DEFAULTS as z, signal as zi, getConstant as zn, isLContainer as zr, assertInjectImplementationNotEqual as zt };
